...
public class ClipToTranslateService extends Service implements View.OnTouchListener
{
    ...
    private Notification.Builder gerarNotificacoesNew()
    {
        ...
        builder.setSmallIcon(R.drawable.ic_paper_clip);
        ...
        Notification.Action aPararServico = new Notification.Action.Builder(Icon.createWithResource(this, android.R.drawable.ic_menu_close_clear_cancel), getResources().getString(R.string.app_service_stop_description), piStop).build();
        ...
        Notification.Action aMostrarEsconder = new Notification.Action.Builder(Icon.createWithResource(this, R.drawable.ic_circle), getResources().getString(R.string.app_service_show_hide_description), piMostrarEsconder).build();
    ...
    public boolean onTouch(View view, MotionEvent event)
    {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                {
                    Intent dialogIntent = new Intent(getBaseContext(), TranslationDialogActivity.class);
